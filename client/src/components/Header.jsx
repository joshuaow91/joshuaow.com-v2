...
function Header() {
  ...
  return (
    <header
        ...
        className={`fixed top-0 left-50 w-full z-20 bg-background max-w-screen-xl  bg-opacity-60 backdrop-blur-md py-3 px-16 flex items-center justify-between transition-all duration-300`}
    >
