...
const Skills = () => {
    ...
    return (
        <div className='flex flex-col items-center w-full justify-center py-40 bg-slate-600 gap-6 '>
            ...
            <div className='grid grid-cols-4 gap-3 gap-x-10 font-light border-1 border-zinc-800 rounded-3xl p-4 px-6 border-r-8 border-b-8 bg-zinc-700'>
