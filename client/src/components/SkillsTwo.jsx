...
const SkillsTwo = () => {
    ...
    return (
        ...
        <div className='flex flex-col-reverse items-center w-full justify-center p-3  sm:p-8  '>
            ...
            <div className='flex flex-col-reverse lg:flex-col-reverse justify-between items-center gap-10 w-full sm:gap-32'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 text-zinc-300 gap-y-6 gap-x-9 font-light select-none w-full md:w-1/2  bg-zinc-500 rounded-3xl border-r-8 border-b-8 border-zinc-800 border-opacity-80 p-8'>
                    ...
                    <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-12 lg:gap-6 w-full select-none p-4 md:p-0 mr-3 sm:mr-0'>
                        <motion.div 
                            ref={ref}
