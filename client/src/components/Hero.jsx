        ...
        <div className="flex items-center p-4 pt-32 pb-14 gap-10 w-full">
            ...
            <div className="flex flex-col ml-20 w-2/3">
                ...
                <div className="flex gap-4">
                    <a href="#" className="mt-10 rounded-full uppercase bg-green-500 w-40 h-12 text-zinc-800 text-sm font-semibold hover:bg-green-600 flex items-center justify-center group border-2 border-zinc-950 border-r-4 border-b-4">
                    ...
                    <a href="#" className="mt-10 rounded-full uppercase  w-40 h-12 text-stone-300 text-sm font-semibold hover:bg-zinc-900 flex items-center justify-center group border-2 border-zinc-950 border-r-4 border-b-4 bg-zinc-800">
            ...
            <div className=" w-1/3 flex items-start">
                <div className="flex-shrink-0  ">
                    <img src={Avatar} className="border-zinc-950 rounded-full border-r-8 border-b-8 border-2 grayscale brightness-100 hover:brightness-75 transition-all ease-in-out duration-500 h-80 w-80 "/>
