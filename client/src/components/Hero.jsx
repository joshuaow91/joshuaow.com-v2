        ...
        <div className="flex justify-center gap-12  w-full items-center">
            ...
            <div className="flex flex-col p-6">
                ...
                <div className="flex gap-4">
                    <a href="#" className="mt-12 rounded-full uppercase bg-green-500 w-40 h-12 text-zinc-800 text-sm font-semibold  flex items-center justify-center group border-1 border-zinc-950 border-r-4 border-b-4">
                    ...
                    <a href="#" className="mt-12 rounded-full uppercase  w-40 h-12 text-stone-300 text-sm font-semibold  flex items-center justify-center group border-1 border-zinc-950 border-r-4 border-b-4 bg-zinc-800">
            ...
            <div className="">
                <img 
                    src={Avatar} 
                    className="border-zinc-950 rounded-full border-r-8 border-b-8 border-1 grayscale brightness-75 hover:brightness-100 transition-all ease-in-out duration-500 h-80 w-80 "
                />
            </div>
