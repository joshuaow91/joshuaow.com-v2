...
const Hero = () => {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-center gap-8 lg:gap-6 xl:gap-16 p-2 pl-8 sm:p-6 w-full items-center">

            <div className="flex flex-col  sm:p-6">
                <h1 className="mt-8 text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl font-extralight text-stone-300 text-opacity-75 ">Hello, my name is Josh.</h1> 
                <h2 className="mt-2 sm:min-w-max font-semibold tracking-wide uppercase text-5xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl text-stone-200 font-paytone">Full-stack Engineer</h2>
