...
const Projects = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-center md:justify-start mx-4 md:mx-0 ">
        <h2 className="text-4xl text-white text-opacity-75 font-paytone tracking-wide uppercase self-start ">
          <FontAwesomeIcon icon={faFolder} className="mr-2 text-cyan-500" />{" "}
          Work
        </h2>
      </div>

      <div className="flex flex-col-reverse lg:flex-row-reverse  items-center gap-4 lg:gap-20 lg:ml-6 ">
        <div className="lg:w-1/2 flex flex-col gap-8 p-4 pl-8 sm:pl-0  py-8">
          ...
          <ul className="flex gap-4 items-center">
            <li className="text-zinc-300 text-opacity-50 uppercase tracking-wide text-sm">
              Tech Stack:
            </li>
            <li>
              <FontAwesomeIcon
          ...
          <span className="text-white text-opacity-60 font-light text-lg md:pr-10 leading-8">
            ...
            replacing an inefficient Excel spreadsheet with a real-time
            platform. The introduction of a custom search tool ensured the
            delivery of high-quality and up-to-date information, significantly
            streamlining data retrieval, improving decision-making accuracy, and
            enhancing overall operational effectiveness. This streamlined
            solution not only addressed operational efficiency but also promoted
            user interaction, created a dynamic leaderboard, and generated
            potential leads. The inclusion of an all-time leaderboard
            incentivized consistent performance, fostering long-term user
            commitment and facilitating business development.
          </span>
            ...
            <div className="flex justify-center gap-4 items-center w-full mb-4">
              <button
                className={`w-32 h-9 flex justify-center items-center text-black font-bold uppercase text-opacity-75 text-sm focus:outline-none ${
                  isLightMode
                    ? "bg-blue-300 border-r-4 border-b-4 rounded-full border-blue-800"
                    : "bg-gray-300 border-r-4 border-b-4 rounded-full border-gray-600"
                }`}
                onClick={() => setLightMode(true)}
              >
                <FontAwesomeIcon
                  icon={faLightbulb}
                  className="mr-2 text-amber-100"
                />{" "}
                Light
              </button>
              <button
              ...
              >
                <FontAwesomeIcon
                  icon={faMoon}
                  className="mr-2 text-yellow-100"
                />{" "}
                Dark
              </button>
            </div>
